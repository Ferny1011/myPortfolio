...
const About = () => {
    ...
    const  handleCopy = () => {
        navigator.clipboard.writeText("fer-ney1011@outlook.com");
        setHasCopied(true);
        setTimeout(() => {
            setHasCopied(false);
        }, 2000);
            ...
            <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            <p className="grid-headtext">Hi, I'm Ferney</p>
                    ...
                    <div className="grid-container">
                        <div className="rounded 3xl w-full sm:h-[326px] h-fit flex justify-center items-center">
                            <Globe height={326} width={326} backgroundColor="rgba(0,0,0,0)" backgroundImageOpacity={0.5}
                                   ...
                                   labelsData={[{
                                       lat: -34.64343515523819, lng: -58.565210803761474,
                                       text: "I'm here!",
                                       color: "white",
                                       size: 20
                            }]}/>
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">I'm based in Argentina, with remote work available.</p>
                    ...
                    <div className="grid-container">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="copy-container" onClick={handleCopy}>
                                ...
                                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">fer-ney1011@outlook.com</p>
                            </div>
                        </div>
                    </div>
                </div>
